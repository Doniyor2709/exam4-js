...
function mappingTeacher() {
  axiosInstance("teacher").then((res) => {
    res.data.map((el) => {
      ...
      } style="background:rgb(168, 97, 255);">
            ${el.firstName}
          </option>
        `;
    });
  ...
  return `
      <div class="card">
        <div class="card-content">
          ...
          <div class="btns">
            <button class="editTeacherInfo" onclick="editTeacherInfo(${id})"><p>Edit</p><img src="https://cdn-icons-png.flaticon.com/128/1046/1046295.png" alt=""></button>
            <button class="deleteTeacherInfo" onclick="deleteChangeTeacher(${id})"><p>Delete</p> <img src="https://cdn-icons-png.flaticon.com/128/1214/1214428.png" alt=""></button>
        </div>
        </div>
      </div>
      `;
